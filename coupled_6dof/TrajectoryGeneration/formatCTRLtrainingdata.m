...
%% Setup Directory
directory = '/orange/rcstudents/omkarmulekar/DistributionShiftStudy/coupled_6dof/trainingdata/';
addpath(directory);
...
save('/orange/rcstudents/omkarmulekar/DistributionShiftStudy/coupled_6dof/ANN2_data.mat','Xfull_2','tfull_2','Xtrain2','ttrain2','Xtest2','ttest2','times_train','times_test','times');
